...
<head>
  ...
  <title>PrettyU Ordering System : Order Details</title>
  <!-- Bootstrap -->
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          ?>
          <option value="<?php echo $productrow['fld_product_num']; ?>"><?php echo $productrow['fld_product_name']." ".$productrow['fld_product_brand']; ?></option>
          <?php
          }
          $conn = null;
          ?>
      ...
      <div class="form-group">
        ...
        <button class="btn btn-default btn-success" type="submit" name="addproduct"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Product</button>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <div class="page-header"  data-backdrop="static">
